from functions.get_files_info import DirInfo, PathItem
import unittest
...
class TestGetFilesInfo(unittest.TestCase):
    ...
    def test_success_current_dir(self):
        (is_err, result_code), _ = DirInfo.get_files_info(working_directory="calculator", 
                                                          dest_directory=".")
    ...
    def test_success_dot_current(self):
        (is_err, result_code), result = DirInfo.get_files_info(working_directory="calculator", 
                                                               dest_directory=".")
    ...
    def test_success_nest(self):
        (_, result_code), result = DirInfo.get_files_info(working_directory="calculator", 
                                                          dest_directory="pkg")
    ...
    def test_error_one(self):
        (_, _), result = DirInfo.get_files_info(working_directory="calculator", 
                                                dest_directory="/bin")
